...
async function getSelfProjectId(): Promise<string | null> {
    ...
    res.on("finish", async () => {
        ...
        try {
            ...
            if (!endpoint) {
                ...
                if (pathTemplate === "/api/auth/login") friendlyName = "User Login";
                else if (pathTemplate === "/api/auth/register") friendlyName = "User Register";
                else if (pathTemplate === "/api/projects") friendlyName = "Projects List/Create";
                else if (pathTemplate === "/api/projects/:id") friendlyName = "Project Detail/Delete";
                else if (pathTemplate === "/api/projects/:projectId/stats") friendlyName = "Get Dashboard Stats";
                else if (pathTemplate === "/api/projects/:id/logs") friendlyName = "Get Project Logs";
