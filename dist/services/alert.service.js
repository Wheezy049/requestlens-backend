...
export const evaluateAlerts = async (projectId) => {
    try {
        ...
        for (const rule of activeRules) {
            ...
            if (errorRate >= rule.thresholdPercentage) {
                ...
                if (project && project.user.email) {
                    ...
                    await sendAlertEmail(project.user.email, project.name, rule, errorRate, errorRequests, totalRequests, failureSummary);
                }
            }
        }
    }
