...
const sendAlertEmail = async (toEmail, projectName, rule, errorRate, errorCount, totalCount, failureSummary) => {
...
export const alertEmailWorker = new Worker("alert-emails", async (job) => {
    ...
    await sendAlertEmail(toEmail, projectName, rule, errorRate, errorCount, totalCount, failureSummary);
}, {
